...
datagroup: khushbu_s_project_advance_deployment_mode_set_up_default_datagroup {
  # sql_trigger: SELECT MAX(id) FROM etl_log;;
  max_cache_age: "1 hour"
}

persist_with: khushbu_s_project_advance_deployment_mode_set_up_default_datagroup
